...
/**
 * Une section = un titre + son contenu, jamais coupes l'un de l'autre (mission §12.2 : "ne
 * jamais couper un titre de sa section"). `wrap={false}` deplace toute la section sur la page
 * suivante si elle ne tient pas dans l'espace restant, plutot que de forcer un saut de page
 * systematique entre chaque section comme le faisait la version precedente (une section par
 * page produisait des pages presque vides) -- demande explicite du produit : "faire juste des
 * sauts de lignes et mettre des titres pour identifier chaque partie".
 */
...
export function ReportDocument({ data }: { data: ReportData }) {
  ...
  return (
    ...
    >
      {/* Couverture -- seule section a garder sur sa propre page. */}
      ...
      {/* Corps du rapport : flux continu, pagine automatiquement selon le contenu. */}
      <Page size="A4" style={styles.page}>
        <Section eyebrow="Introduction">
          ...
          <Text style={styles.paragraph}>
            ...
            <Text style={{ fontFamily: "Helvetica-Bold" }}>Phase actuelle</Text>), et
            d'éventuelles périodes passées où une autre motivation a dominé durablement (tes{" "}
          ...
          <Text style={styles.paragraph}>
            ...
            après une période de stress durable ou un changement important : elle influence
            surtout tes besoins psychologiques et la forme que prend ton stress, pas ta perception
            ni ton style de fond, qui restent ceux de ta Base.
          </Text>
          <Text style={styles.h3}>Limites de l'outil</Text>
          <Text style={styles.paragraph}>
        ...
        <Section eyebrow="Synthèse">
          ...
          <Text style={styles.paragraph}>
            ...
            {base.strengthsNarrative.toLowerCase()} En ce moment, ce qui te motive
            particulièrement se rapproche du profil {phase.name.toLowerCase()} :{" "}
            {phase.needPositiveSign.toLowerCase()}
          </Text>
        </Section>

        <SectionDivider />

        <Section eyebrow="Structure de personnalité">
          <Text style={styles.h2}>L'immeuble à six étages</Text>
          <Text style={styles.paragraph}>
            Chaque personne porte en elle les six types, à des degrés différents. Ta Base occupe
            le rez-de-chaussée : c'est le fonctionnement le plus stable et le plus ancien. Les
            étages supérieurs représentent des ressources plus ou moins facilement accessibles.
          </Text>
          <Text style={styles.notice}>
            Un pourcentage de 100% ne signifie pas la même chose partout : il indique un statut
            validé (Base, Phase actuelle, ou Phase vécue confirmée), pas une intensité brute. Les
            autres pourcentages traduisent une accessibilité relative entre les six types.
          </Text>
          {result.structureBuilding.map((floor) => (
            <View key={floor.typeCode} style={styles.floorRow}>
              ...
              <View style={{ flex: 1 }}>
                <Text
                  style={{ fontFamily: "Helvetica-Bold", color: REPORT_COLORS[floor.typeCode] }}
                >
        ...
        <Section eyebrow="Styles d'interaction">
        ...
        <Section eyebrow="Parties de personnalité">
          <Text style={styles.h2}>Ta partie la plus naturelle : {base.part}</Text>
          <Text style={styles.paragraph}>{base.partNarrative}</Text>
          <Text style={styles.small}>
            Ordinateur, Directeur, Réconforteur et Émoteur désignent des façons différentes de
            traiter une situation ou de s'adresser à quelqu'un ; leur accessibilité varie selon
            les étages de ta Structure.
          </Text>
        </Section>

        <SectionDivider />

        <Section eyebrow="Canaux de communication">
        ...
        <Section eyebrow="Environnements préférés">
        ...
        <Section eyebrow="Besoins psychologiques">
        ...
        <Section eyebrow="Phase actuelle et Phases vécues">
        ...
        <Section eyebrow="Satisfaction négative des besoins">
          <Text style={styles.h2}>Signaux précoces à surveiller</Text>
          <Text style={styles.paragraph}>
            Quand le besoin de {phase.need.toLowerCase()} n'est pas satisfait, certains
            comportements peuvent apparaître progressivement. Ils ne sont pas des défauts : ce
            sont des signaux à écouter avant qu'ils ne s'intensifient.
          </Text>
          <Text style={styles.paragraph}>{phase.needLackSign}</Text>
        </Section>
        ...
        <Section eyebrow="Séquence de stress">
        ...
        <Section eyebrow="Méthode et limites">
          ...
          <Text style={styles.paragraph}>
            ...
            officielle (test-retest, comparaison à des profils certifiés, étude de la
            désirabilité sociale). Le barème et les pondérations utilisés sont provisoires et
            pourront être recalibrés (voir docs/SOURCE_MAPPING.md et docs/SCORING.md du projet).
          </Text>
          <Text style={styles.paragraph}>
